...
public class TestZKImpl {
  public static void main(String[] args) {
    try {
      ...
      System.out.println("Retrieve Id to Name map from ZK #1: "
      ...
      System.out.println("Retrieve Id to Name map from ZK #2: "
          + new String(zoo.getData(zPath, false, null), UTF_8));
      ...
      System.out.println("Retrieve Id to Name map from ZK #3: "
          + new String(zoo.getData(zPath, false, null), UTF_8));
      ...
      System.out.println("Retrieve Id to Name map from ZK #4: "
          + new String(zoo.getData(zPath, false, null), UTF_8));
      ...
      System.out.println(
          "getNamespaceId(test2): " + Namespaces.getNamespaceId(context, "testNamespace2"));

      // Test getNamespaceName
      System.out.println("\ngetNamespaceName(test1): "
      ...
      System.out.println("\nCleared map: " + new String(zoo.getData(zPath, false, null), UTF_8));

      // Add names
      zooReaderWriter.putPersistentData(
          zPath + "/" + NamespaceId.of("testNamespaceId") + Constants.ZNAMESPACE_NAME,
          "testNamespace".getBytes(UTF_8), ZooUtil.NodeExistsPolicy.OVERWRITE);
      zooReaderWriter.putPersistentData(
          zPath + "/" + NamespaceId.of("testNamespaceId2") + Constants.ZNAMESPACE_NAME,
          "testNamespace2".getBytes(UTF_8), ZooUtil.NodeExistsPolicy.OVERWRITE);
      zooReaderWriter.putPersistentData(
          zPath + "/" + NamespaceId.of("testNamespaceId3") + Constants.ZNAMESPACE_NAME,
          "testNamespace3".getBytes(UTF_8), ZooUtil.NodeExistsPolicy.OVERWRITE);
      zooReaderWriter.putPersistentData(
          zPath + "/" + NamespaceId.of("+default") + Constants.ZNAMESPACE_NAME, "".getBytes(UTF_8),
          ZooUtil.NodeExistsPolicy.OVERWRITE);
      zooReaderWriter.putPersistentData(
          zPath + "/" + NamespaceId.of("+accumulo") + Constants.ZNAMESPACE_NAME,
          "accumulo".getBytes(UTF_8), ZooUtil.NodeExistsPolicy.OVERWRITE);
      System.out.println("testnamespaceIds: " + zooReaderWriter.getChildren(zPath));
      System.out
          .println("testnamespaceId name: " + new String(
              zooReaderWriter.getData(
                  zPath + "/" + NamespaceId.of("testNamespaceId") + Constants.ZNAMESPACE_NAME),
              UTF_8));
      System.out.println("testnamespaceId2 name: " + new String(
          zooReaderWriter.getData(
              zPath + "/" + NamespaceId.of("testNamespaceId2") + Constants.ZNAMESPACE_NAME),
          UTF_8));
      System.out.println("testnamespaceId3 name: " + new String(
          zooReaderWriter.getData(
              zPath + "/" + NamespaceId.of("testNamespaceId3") + Constants.ZNAMESPACE_NAME),
          UTF_8));
      System.out.println("+accumulo name: " + new String(zooReaderWriter
          .getData(zPath + "/" + NamespaceId.of("+accumulo") + Constants.ZNAMESPACE_NAME), UTF_8));
      System.out.println("+default name: " + new String(zooReaderWriter
          .getData(zPath + "/" + NamespaceId.of("+default") + Constants.ZNAMESPACE_NAME), UTF_8));
      ...
      for (String namespaceId : namespaceIdList) {
        ...
        namespaceMap.put(namespaceId,
            new String(zooReaderWriter.getData(namespaceNamePath), UTF_8));
        zooReaderWriter.delete(namespaceNamePath);
      }
      zooReaderWriter.putPersistentData(zPath, NamespaceMapping.serialize(namespaceMap),
          ZooUtil.NodeExistsPolicy.OVERWRITE);
      System.out.println("Map after upgrade:" + new String(zoo.getData(zPath, false, null), UTF_8));
